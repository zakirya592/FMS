...
export default function Updateemployeeroomassingment({ route }) {
    const { myFunction } = route.params
    const { employeeroomassignmentpage } = route.params
    ...
    const handleProvinceChangeDesignationCode = (selectedValue) => {
        const Deptnale = selectedValue.DesignationCode;
        setvalue((prevValue) => ({
            ...prevValue,
        ...
        axios.get(`/api/Designation_GET_BYID/${Deptnale}`)
            .then((res) => {
                if (res.data.recordset && res.data.recordset.length > 0) {
                    ...
                    setvalue((prevValue) => ({
                        ...prevValue,
                        DesignationName: responseData.DesignationDesc || '',
                    }));
                } else {
                    setvalue((prevValue) => ({
                        ...prevValue,
    ...
    const getapi = () => {
        axios.get(`/api/EmployeeRooms_GET_BYID/${employeeroomassignmentpage}`)
            .then((res) => {
                setvalue((prevValue) => ({
                    ...prevValue,
                ...
                const EmployeeIDnumber = res.data.data[0].EmployeeID
                axios.post(`/api/getworkRequest`, {
                    ...
                    setvalue((prevValue) => ({
                        ...prevValue,
                        EmployeeName: CompleteddEmployeeName
                    }));
    ...
    const postapi = () => {
        axios.put(`/api/EmployeeRooms_Put/${employeeroomassignmentpage}`, {
    ...
    return (
        <ScrollView contentContainerStyle={styles.containerscrollview}>
            <View>
                ...
                {/* Designation Code and Designation Name  */}
                <View style={styles.inputContainer}>
                ...
                <AwesomeAlert
                    ...
                    message={`Employee Room Assignments ${employeeroomassignmentpage} has been update`}
