...
export default function Updatapreventivemaintenance({ route }) {
    ...
    const Createapi = () => {
        axios.put(`/api/PreventiveMaintenance_Put/${RequestNumber}`, {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.containerscrollview}>
            <View>
                <View >
                    <Text style={styles.prograp}>Modify Preventive Maintenance</Text>
                </View>
                ...
                <AwesomeAlert
                    ...
                    message={`Preventive ${value.WorkRequestNo} has been created updated`}
