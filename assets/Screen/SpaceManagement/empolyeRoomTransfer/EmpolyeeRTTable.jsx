  ...
  const [items, setItems] = useState ([
    {
      ...
      Seq: '1',
      TransferNumber: 'Open',
      EmployeeNumber: 'InvoiceNumbe',
      RequestDate: 'DiscountAmount',
      FROMRoomCode: '12/12/3003',
      TORoomCode: 'InvoiceDate',
      stLevelEmpCode: 'LASTPURCHASEDATE',
      ndLevelEmpCode: 'PURCHASEAMOUNT',
      rdLevelEmpCode: 'PURCHASEAMOUNT',
      ACTIONS: 'Open',
    },
      ...
      <View>
          ...
          >
            <DataTable.Header>
              ...
              <DataTable.Title style={[styles.header, {width: 180}]}>
                <Text style={styles.tableHeading}>Transfer Number</Text>
              </DataTable.Title>
              <DataTable.Title style={[styles.header, {width: 160}]}>
                <Text style={styles.tableHeading}>Employee Number</Text>
              </DataTable.Title>
              ...
              <DataTable.Title style={[styles.header, {width: 170}]}>
                <Text style={styles.tableHeading}>FROM-Room Code</Text>
              </DataTable.Title>
              <DataTable.Title style={[styles.header, {width: 130}]}>
                <Text style={styles.tableHeading}>TO-Room Code</Text>
              </DataTable.Title>

               <DataTable.Title style={[styles.header, {width: 140}]}>
                <Text style={styles.tableHeading}>1st Level - Emp. Code</Text>
              </DataTable.Title>
              <DataTable.Title style={[styles.header, {width: 170}]}>
                <Text style={styles.tableHeading}>2nd Level - Emp. Code</Text>
              </DataTable.Title>
              <DataTable.Title style={[styles.header, {width: 130}]}>
                <Text style={styles.tableHeading}>3rd Level - Emp. Code</Text>
              </DataTable.Title>
              <DataTable.Title
                style={[
                  styles.header,
        ...
        <View style={styles.buttonsection}>
          <Button
            ...
            onPress={() => navigation.navigate ('EmpolyeeRTUpdate')}
          >
            Update
          </Button>
          <Button
            ...
            onPress={() => navigation.navigate ('EmpolyeeRTCreate')}
          >
            <Icon
              name="add"
              color="#0A2DAA"
