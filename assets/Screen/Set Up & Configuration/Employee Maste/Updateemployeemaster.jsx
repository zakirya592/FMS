...
export default function Updateemployeemaster({ route }) {
    ...
    const postapi = () => {
        axios.put(`/api/EmployeeMaster_Put/${EmployeeID}`, formData, config)
            .then((res) => {
        ...
        <ScrollView contentContainerStyle={styles.containerscrollview}>
            <View>
                ...
                <AwesomeAlert
                    ...
                    message={`Employee Master ${EmployeeID} has been Updated`}
