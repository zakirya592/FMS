...
export default function GoodReturnUpdate({ route }) {
  ...
  const Createapi = () => {
    axios.put(`/api/GoodsReturn_Put/${PurchaseOrderNumber}`, {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.containerscrollview}>
      <View>
        <View >
          <Text style={styles.prograp}>Modify  Goods Return</Text>
        </View>
        {/* Purchase Order  */}
        ...
        <AwesomeAlert
          ...
          message={`Goods Return ${PurchaseOrderNumber} has been Update`}
          confirmButtonColor="#DD6B55"
          confirmButtonStyle={{ backgroundColor: 'black' }}
