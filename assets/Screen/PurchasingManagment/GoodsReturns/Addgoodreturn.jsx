...
export default function Addgoodreturn({ route }) {
    ...
    return (
        <ScrollView>
            <View>
                {/* Top section */}
                <View >
                    <Text style={styles.prograp}>Goods Return
                    </Text>
                    <View style={styles.inputContainer}>
                        ...
                        <Text style={[styles.lableinput, { marginTop: 35 }]}>{PurchaseOrderNumber}</Text>
                    </View>
                </View>
                {/* table section */}
                ...
                {/* PurchaseOrderNumber add  Dialog*/}
                <Dialog isVisible={visible2} onBackdropPress={toggleDialog2}>
                    <Dialog.Title title="Are you sure?" />
                    <Text>{`You want to Add the Purchase Order Number `}</Text>
                    <Dialog.Actions >
                ...
                <AwesomeAlert
                    ...
                    message={`The selected records are added to the Purchase Order Number ${PurchaseOrderNumber}`}
