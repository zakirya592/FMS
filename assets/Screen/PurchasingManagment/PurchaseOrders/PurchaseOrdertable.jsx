  ...
  return (
    <ScrollView>
      <View>
        {/* Top section */}
        <View >
          <Text style={styles.prograp}>Purchase Orders
          </Text>
        </View>
        {/* table section */}
        <ScrollView horizontal >
          <DataTable style={[styles.item, {
            ...
            <DataTable.Header>
              ...
              <DataTable.Title style={[styles.header, { width: 140 }]} ><Text style={styles.tableHeading}>PO Date</Text></DataTable.Title>
        ...
        <Dialog isVisible={visible2} onBackdropPress={toggleDialog2}>
          ...
          <Text>{`You want to delete this ${deleteItemCode} Purchase Order Number`}</Text>
          <Dialog.Actions >
        ...
        <AwesomeAlert
          ...
          message={`Purchase Order Number ${deleteItemCode} has been deleted`}
