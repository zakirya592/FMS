  ...
  const [items, setItems] = useState ([
    {
      _id: 1,
      Seq: '1',
      PurchaseRequestNumber: 'Open',
      RequestByEmployeeID: 'InvoiceNumbe',
      VerifiedByEmployee: 'DiscountAmount',
      VerifiedByEmployee: '12/12/3003',
      InvoiceDate: 'InvoiceDate',
      VendorID: 'LASTPURCHASEDATE',
      RequestDate: 'PURCHASEAMOUNT',
      ACTIONS: 'Open',
    },
      ...
      <View>
          ...
          >
            <DataTable.Header>
              ...
              <DataTable.Title style={[styles.header, {width: 160}]}>
                <Text style={styles.tableHeading}>Request By EmployeeID</Text>
              </DataTable.Title>
              <DataTable.Title style={[styles.header, {width: 140}]}>
                <Text style={styles.tableHeading}>Verified By Employee</Text>
              </DataTable.Title>
        ...
        <View style={styles.buttonsection}>
          <Button
            ...
            onPress={() => navigation.navigate ('PurchaseRequestUpdate')}
          >
            Update
          </Button>
          <Button
