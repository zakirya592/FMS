...
export default function PurchaseRequestCreate({ route }) {
  ...
  const Assetcodebtn = (e) => {
    navigation.navigate(`Addpurchaserequest`, { PurchaseRequestNumber: value.PurchaseRequest, myFunction: getapi })
  }
  ...
  const Createapi = () => {
    axios.post(`/api/PurchaseRequest_post`, {
      ...
      RequestByEmployeeID: value.EmployeeNumber,
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.containerscrollview}>
      <View>
        <View >
          <Text style={styles.prograp}>Create Purchase Requests</Text>
        </View>
        ...
        <AwesomeAlert
          ...
          message={` Purachase Requests ${value.PurchaseRequest} has been created successfully`}
          confirmButtonColor="#DD6B55"
          confirmButtonStyle={{ backgroundColor: 'black' }}
          ...
          confirmText="OK"
          onConfirmPressed={() => {
            navigation.navigate('Purchaserequesttable')
            myFunction()
          }}
        />
      </View>
