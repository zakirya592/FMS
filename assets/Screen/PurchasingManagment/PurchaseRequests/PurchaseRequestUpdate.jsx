...
export default function PurchaseRequestUpdate({ route }) {
  ...
  const Createapi = () => {
    axios.put(`/api/PurchaseRequest_Put/${PurchaseRequestNumber}`, {
      RequestDate: date,
    ...
    <ScrollView contentContainerStyle={styles.containerscrollview}>
      <View>
        ...
        <AwesomeAlert
          ...
          message={` Purachase Requests ${value.PurchaseRequest} has been Updated `}
          confirmButtonColor="#DD6B55"
          confirmButtonStyle={{ backgroundColor: 'black' }}
