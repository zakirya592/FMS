...
export default function AssetTransactionsUpdate({ route }) {
  ...
  const addtransaction = async () => {
    axios.put(`/api/AssetTransactions_Put/${AssetItemTagID}`, {
    ...
    <ScrollView contentContainerStyle={styles.containerscrollview}>
      <View>
        ...
        <AwesomeAlert
          ...
          message={`Asset Transactions ${AssetItemTagID} has been updated successfully`}
