...
export default function Createworktypes({ myFunction }) {
    const [value, setvalue] = useState({
        WorkTypeCode: '', WorkTypeDesc: ''
    })
            ...
            <Dialog isVisible={showmodel} >
                <View style={{ marginTop: 20 }}>
                    <View style={styles.singleinputlable}>
                        <Text style={styles.lableinput}>Work Types Code
                        </Text>
                        <TextInput
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        <Text style={styles.lableinput}>Work Types Description
                        </Text>
                        <TextInput
                            style={[styles.inputBox]}
