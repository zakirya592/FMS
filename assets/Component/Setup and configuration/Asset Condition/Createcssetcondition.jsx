...
export default function Createcssetcondition({ myFunction }) {
  ...
  return (
    <View>
      ...
      <Dialog isVisible={showmodel} >
        <Dialog.Title title="Create Asset Condition" />
        ...
        <View style={{ marginTop: 20 }}>
          <View style={styles.singleinputlable}>
            ...
            <TextInput
              ...
              onChangeText={item => {
                setvalue((prevValue) => ({
                  ...prevValue,
                  AssetConditionCode: item, // Update the Employeeid property
                }));
              }}
          ...
          <View style={[styles.singleinputlable, { marginTop: 15 }]}>
            <Text style={styles.lableinput}> Asset Condition Description
            </Text>
            <TextInput
              style={[styles.inputBox]}
              ...
              placeholder="Asset Condition Description"
              placeholderTextColor="#94A0CA"
              selectionColor="#1D3A9F"
              underlineColorAndroid="transparent"
            />
