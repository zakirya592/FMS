...
export default function Createdayscode({ myFunction }) {
    const [value, setvalue] = useState({
        DaysCode: '', DaysDesc: '', DaysSeq: ''
    })
            ...
            <Dialog isVisible={showmodel} >
                <View style={{ marginTop: 20 }}>
                    <View style={styles.singleinputlable}>
                        <Text style={styles.lableinput}>Day Code
                        </Text>
                        <TextInput
                            ...
                            onChangeText={item => {
                                setvalue((prevValue) => ({
                                    ...prevValue,
                                    DaysCode: item, // Update the Employeeid property
                                }));
                            }}
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        ...
                        <TextInput
                            ...
                            onChangeText={item => {
                                setvalue((prevValue) => ({
                                    ...prevValue,
                                    DaysSeq: item, // Update the Employeeid property
                                }));
                            }}
                            placeholder="Day Seq"
                            placeholderTextColor="#94A0CA"
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        <Text style={styles.lableinput}>Day Description
                        </Text>
                        <TextInput
                            style={[styles.inputBox]}
