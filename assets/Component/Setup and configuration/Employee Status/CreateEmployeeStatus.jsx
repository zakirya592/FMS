...
export default function CreateEmployeeStatus({ myFunction }) {
    const [value, setvalue] = useState({
        EmployeeStatusCode: '', EmployeeStatusDesc: '',
    })
    ...
    const postapi = (e) => {
        ...
        axios.post(`/api/EmployeeStatus_post`, {
            EmployeeStatusCode: value.EmployeeStatusCode,
    ...
    return (
        <View>
            ...
            <Dialog isVisible={showmodel} >
                <Dialog.Title title="Create Employee Status" />
                ...
                <View style={{ marginTop: 20 }}>
                    <View style={styles.singleinputlable}>
                        ...
                        <TextInput
                            ...
                            onChangeText={item => {
                                setvalue((prevValue) => ({
                                    ...prevValue,
                                    EmployeeStatusCode: item, // Update the Employeeid property
                                }));
                            }}
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        <Text style={styles.lableinput}> Employee Status Description
                        </Text>
                        <TextInput
                            style={[styles.inputBox]}
                            ...
                            placeholder="Employee Status Description"
                            placeholderTextColor="#94A0CA"
                            selectionColor="#1D3A9F"
                            underlineColorAndroid="transparent"
                        />
