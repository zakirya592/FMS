    ...
    return (
        <View>
            ...
            <Dialog isVisible={showmodel} >
                <Dialog.Title title="Create Asset Sub Category" />
                ...
                <View style={{ marginTop: 20 }}>
                    <View style={styles.singleinputlable}>
                        ...
                        <TextInput
                            ...
                            onChangeText={item => {
                                setvalue((prevValue) => ({
                                    ...prevValue,
                                    AssetSubCategoryCode: item, // Update the Employeeid property
                                }));
                            }}
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        <Text style={styles.lableinput}> Asset Sub Category Description
                        </Text>
                        <TextInput
                            style={[styles.inputBox]}
                            ...
                            placeholder="Asset Sub Category Description"
                            placeholderTextColor="#94A0CA"
                            selectionColor="#1D3A9F"
                            underlineColorAndroid="transparent"
                        />
