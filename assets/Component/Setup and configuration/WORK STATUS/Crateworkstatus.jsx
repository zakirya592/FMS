...
export default function Crateworkstatus({ myFunction }) {
            ...
            <Dialog isVisible={showmodel} >
                <View style={{ marginTop: 20 }}>
                    <View style={styles.singleinputlable}>
                        ...
                        <TextInput
                            ...
                            onChangeText={item => {
                                setvalue((prevValue) => ({
                                    ...prevValue,
                                    WorkStatusCode: item, // Update the Employeeid property
                                }));
                            }}
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        <Text style={styles.lableinput}>Work Status Description
                        </Text>
                        <TextInput
                            style={[styles.inputBox]}
                            ...
                            placeholder="Work Status Description"
                            placeholderTextColor="#94A0CA"
                            selectionColor="#1D3A9F"
                            underlineColorAndroid="transparent"
                        />
