...
export default function Createcarital({ myFunction }) {
    ...
    return (
        <View>
            ...
            <Dialog isVisible={showmodel} >
                <Dialog.Title title="Create Marital" />
                ...
                <View style={{ marginTop: 20 }}>
                    <View style={styles.singleinputlable}>
                        ...
                        <TextInput
                            ...
                            onChangeText={item => {
                                setvalue((prevValue) => ({
                                    ...prevValue,
                                    MaritalCode: item, // Update the Employeeid property
                                }));
                            }}
                    ...
                    <View style={[styles.singleinputlable, { marginTop: 15 }]}>
                        <Text style={styles.lableinput}> Marital Description
                        </Text>
                        <TextInput
                            style={[styles.inputBox]}
                            ...
                            placeholder="Marital Description"
                            placeholderTextColor="#94A0CA"
                            selectionColor="#1D3A9F"
                            underlineColorAndroid="transparent"
                        />
